...
public final class AbsParser extends FunctionParser {
    public AbsParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        final Node.KeywordTree function =
            (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.ABS);
