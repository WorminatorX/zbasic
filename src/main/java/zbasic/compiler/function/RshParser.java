...
public final class RshParser extends FunctionParser {
    public RshParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        return (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.RSH, number, bitCount);
    }
}
