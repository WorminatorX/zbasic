...
public final class RightParser extends FunctionParser {
    public RightParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        return (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.RIGHT_, string, count);
    }
}
