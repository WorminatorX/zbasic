...
public final class LshParser extends FunctionParser {
    public LshParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        return (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.LSH, number, bitCount);
    }
}
