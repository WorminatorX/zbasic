...
public final class ChrParser extends FunctionParser {
    public ChrParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        final Node.KeywordTree function =
            (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.CHR_);
