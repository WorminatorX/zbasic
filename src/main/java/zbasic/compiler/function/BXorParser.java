...
public final class BXorParser extends FunctionParser {
    public BXorParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        return (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.BXOR, numberA, numberB);
    }
}
