...
public final class LeftParser extends FunctionParser {
    public LeftParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        return (Node.KeywordTree)NodeFactory.getInstance().createKeywordTree(Keyword.LEFT_, string, count);
    }
}
