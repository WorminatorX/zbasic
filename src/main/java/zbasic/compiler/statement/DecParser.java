...
public final class DecParser extends StatementParser {
    public DecParser(TokenScanner ts, Context context) {
        super(ts, context);
    }
    ...
    public Node.KeywordTree parse() throws ParserException {
        ...
        final Node.KeywordTree statement = (Node.KeywordTree)nf.createKeywordTree(Keyword.DEC, lvalue);
